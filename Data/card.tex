...
Robust standard error &               &       0.081   \\
F statistic for IV in first stage&               &      16.515   \\
Anderson-Rubin test &               &        0.01   \\
N                   &       3,003   &       3,003   \\
...
\begin{tablenotes}
\tiny
\item Robust standard errors in parenthesis. * p$<$0.10, ** p$<$0.05, *** p$<$0.01
\end{tablenotes}
\end{threeparttable}
\end{center}
\end{table}
